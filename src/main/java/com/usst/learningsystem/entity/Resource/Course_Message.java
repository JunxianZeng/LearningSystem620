...
public class Course_Message
{
    ...
    public Course_Message(int ID, int courseID, String studentID, Date time, String messageContent, int positiveNumber, int negativeNumber, boolean toped)
    {
        this.ID = ID;
